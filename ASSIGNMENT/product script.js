...
function displayProducts(productList = products) {
    ...
    let data = productList.map(function(product) {
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                onclick="deleteByCard(${product.id})">
                Delete
                </button>
    ...
    document.getElementById("productContainer").innerHTML = data.join("");
}
...
function findProduct() {
    ...
    let searchTitle = document.getElementById("findTitle").value.toLowerCase();

    let found = products.find(function(product) {

        return product.title.toLowerCase() === searchTitle;
